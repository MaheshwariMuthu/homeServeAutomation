...
@sale
Scenario: Complete Monthly sale in Ottawa-french with PaymetType as Checking Account
...
@sale
	Scenario: Complete Quarterly sale in Ottawa-french with PaymetType as Checking Account
    When the user selects the plan and add to cart add and Proceed To Checkout
...
@sale
Scenario: Complete Annually sale in Ottawa-french with PaymetType as Checking Account
	When the user selects the plan and add to cart add and Proceed To Checkout
