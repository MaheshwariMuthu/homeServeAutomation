...
//		closeCookiesBottom();
	...
	public void handleEnterCodePopups() throws Exception {
		System.out.println("handle EnterCode Popups if any");
		waitTillPageLoad();
		Thread.sleep(2000);
		if (waitForElementavailblilityboolean(commonPageLocators.entercodepopup,"Water popup",30)) {
			clickElement(commonPageLocators.entercodepopupClose, "Water popup",true);
			waitTillPageLoad();
		}
	}
...
//			same code with different locators
	...
	public void enterUserDetails(String Zipcode,String City) throws InterruptedException {
		...
		PhoneNumber = "45070"+RandomStringUtils.randomNumeric(3)+"34";
