...
public class HSLandingPageActions {
	...
	//		if(commonPageLocators.other_Customers_Purchased.getText().equalsIgnoreCase("Other customers also purchased:"))
			clickElement(commonPageLocators.proceedToCheckout, "Proceed To Checkout");
		}
	...
	public void entercontactDetails() throws InterruptedException, FileNotFoundException, IOException, ParseException {
		...
		Email = "homeservertesting+" + generateRandomEmail + "@gmail.com";
	...
	public void enterAccountDetails(String Value) throws Exception {
	 ...
	 * @throws InterruptedException 
	 */
	public void verifyOrderConformedSuccessfully() throws InterruptedException {
		waitTillPageLoad();
		Thread.sleep(30000);

		if(commonPageLocators.AddressNotFound.getText().equalsIgnoreCase("Address not found!")||
			...
			orderNumberText = commonPageLocators.orderNumber.getText();
